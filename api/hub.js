// QuakeReady verify + admin + download in one module (Vercel serverless)
// Routes:
...
const PEPPER = process.env.ACCESS_PEPPER || 'quakeready-pepper-f40c2e39';

const FILES = [
  'core-guide.pdf', 'home-hazard-hunt.pdf', 'go-bag-checklist.pdf', 'drop-cover-hold-drill.pdf',
  'family-emergency-plan.pdf', 'aftershock-safety-card.pdf', 'work-car-travel-playbook.pdf', '12-week-tracker.pdf',
];
